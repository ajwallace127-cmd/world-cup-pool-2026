...
def _build_bracket_tab(round_matches: dict) -> str:
    ...
    <div class="tab-pane fade" id="tab-bracket" role="tabpanel">
      ...
      <div class="container-inner">
        <p class="text-muted small mb-4">Fills in automatically as matches are played · Group stage runs June 12–27</p>
        {rounds_html}
      </div>
    </div>"""
  ...
  <style>
    ...
    *, body {{ font-family:'Inter',sans-serif; color:var(--text); }}
    ...
    .hero {{
      position:relative;
      background:
        linear-gradient(to bottom, rgba(6,78,59,.6) 0%, rgba(6,95,70,.72) 60%, rgba(3,47,36,.95) 100%),
    ...
    .hero::before {{
      ...
      background-image:
        radial-gradient(ellipse 60% 50% at 50% 100%, rgba(255,255,255,.08) 0%, transparent 70%),
        repeating-linear-gradient(90deg, transparent, transparent 9.09%, rgba(255,255,255,.03) 9.09%, rgba(255,255,255,.03) 9.2%);
      pointer-events:none;
    }}
