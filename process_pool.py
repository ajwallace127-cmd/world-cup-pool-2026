...
MANUAL_ADVANCED: set = {
    ...
    "Mexico", "South Africa",
    # Group B: Switzerland 1st, Canada 2nd, Bosnia 3rd (confirmed best-3rd)
    "Switzerland", "Canada", "Bosnia",
    # Group C: Brazil 1st, Morocco 2nd
    "Brazil", "Morocco",
    # Group D: United States 1st, Australia 2nd
    "United States", "Australia",
    # Group E: Germany 1st, Ivory Coast 2nd, Ecuador 3rd (confirmed best-3rd)
    "Germany", "Ivory Coast", "Ecuador",
    # Group F: Netherlands 1st, Japan 2nd, Sweden 3rd (confirmed best-3rd)
...
# 2026 format: 8 of 12 third-place teams advance — never auto-eliminate based on
# games played. List ONLY teams whose elimination is mathematically confirmed (4th place).
# Do NOT add 3rd-place teams until the best-8 decision is made after all groups finish.
MANUAL_ELIMINATED: set = {
    ...
    "Curacao",        # Group E, 4th
}  # Still TBD (3rd-place, best-8 candidates): South Korea, Scotland, Paraguay,
   # Iraq or Senegal (3rd in Group I), plus all teams from Groups G, H still playing
