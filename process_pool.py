...
MANUAL_ADVANCED: set = {
    "Argentina", "Colombia", "France", "Germany", "Mexico", "Norway", "South Africa", "United States",
    "Switzerland", "Canada", "Bosnia", "Brazil", "Morocco",
...
# games played. List ONLY teams whose elimination is mathematically confirmed.
MANUAL_ELIMINATED: set = {
    "Haiti", "Tunisia", "Jordan", "Panama", "Qatar", "Czech Republic",
}  # 4th-place teams confirmed out. Do NOT add 3rd-place teams until best-8 is decided.
