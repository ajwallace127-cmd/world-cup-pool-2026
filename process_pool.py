...
def generate_html(standings: list, team_results: dict, advanced: set,
    ...
    for tier, teams in TIER_DEFS.items():
        for team in teams:
            ...
            elif played and pts==0: status = "played_zero"
    ...
    status_order = {"champion": 0, "advanced": 1, "active": 1, "played_zero": 1, "not_played": 2, "out": 3}
    ...
    for t in all_teams_data:
        ...
        elif t["status"] == "played_zero":
            row_cls, status_html = "tr-zero", '<span class="ts-zero">– Played / 0 pts</span>'
